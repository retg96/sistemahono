<?php
  $page_title = 'Agregar Tipo de SNI';
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_sni.php" class="clearfix">
              ...
              <button type="submit" name="add_sni" class="btn btn-primary">Agregar</button>
