    ...
    <div class="panel panel-default">
     ...
     <div class="panel-body">
      <table class="table table-bordered table-striped" id="mitabla">
        ...
        <tbody class="boddy">
        <?php foreach($all_nacionalidades as $nacionalidad): ?>
          <tr>
           <!-- <td class="text-center"><?php echo count_id();?></td> -->
           <!-- <td><?php echo remove_junk(ucwords($nacionalidad['id']))?></td> -->
           <td><?php echo remove_junk(ucwords($nacionalidad['Nacionalidad']))?></td>
           
           <td class="text-center">
           <div class="btn-group">
              <a href="edit_nacionalidad.php?id=<?php echo (int)$nacionalidad['id'];?>" class="btn btn-warning btn-xs" style="margin: 2px !important;" title="Editar" data-toggle="tooltip">
                <span class="glyphicon glyphicon-edit"></span>
              </a>

              <a href="delete_nacionalidad.php?id=<?php echo (int)$nacionalidad['id'];?>" class="btn btn-danger btn-xs btn-del" style="margin: 2px !important;" title="Eliminar" data-toggle="tooltip">
