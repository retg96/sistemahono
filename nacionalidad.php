      ...
      <table class="table table-bordered table-striped" id="mitabla">
        ...
        <?php foreach($all_nacionalidades as $nacionalidad): ?>
          <tr>
           ...
           <div class="btn-group">
              <a href="edit_personal.php?id=<?php echo (int)$nacionalidad['id'];?>" class="btn btn-warning btn-xs" style="margin: 2px !important;" title="Editar" data-toggle="tooltip">
                <span class="glyphicon glyphicon-edit"></span>
              </a>

              <a href="delete_personal.php?id=<?php echo (int)$nacionalidad['id'];?>" class="btn btn-danger btn-xs btn-del" style="margin: 2px !important;" title="Eliminar" data-toggle="tooltip">
