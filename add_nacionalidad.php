<?php
  $page_title = 'Agregar Nacionalidad';
...
?>
<?php
 	if(isset($_POST['add_nacionalidad'])){
		...
		if(empty($errors)){
			...
			//  }
			//  $date    = make_date();
			$query  = "INSERT INTO nacionalidad (";
			$query .=" Nacionalidad";
			$query .=") VALUES (";
			$query .=" '{$p_fi}'";
			$query .=")";
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_nacionalidad.php" class="clearfix">
              ...
              <button type="submit" name="add_nacionalidad" class="btn btn-primary">Agregar</button>
