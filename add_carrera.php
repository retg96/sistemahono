<?php
  $page_title = 'Agregar Tipo de Carrera';
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar Tipo de Carrera</span>
         </strong>
        </div>
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_carrera.php" class="clearfix">
              ...
              <button type="submit" name="add_carrera" class="btn btn-primary">Agregar</button>
