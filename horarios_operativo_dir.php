		...
		?>
          ...
          <td><?php echo remove_junk(ucwords($tregimen['Regimen']))?></td>
           ...
           <div class="btn-group">
              ...
              <a href="horario_ope_detalles_dir.php?id=<?php echo (int)$f['IdConvenioOpe'];?>" class="btn btn-success btn-xs" style="margin: 2px !important;" title="Editar" data-toggle="tooltip">
