...
<?php
 	if(isset($_POST['add_area'])){
		...
		if(empty($errors)){
			...
			//  }
			//  $date    = make_date();
			$query  = "INSERT INTO areaacademica (";
			$query .=" AreaAcademica";
			$query .=") VALUES (";
			$query .=" '{$p_fi}'";
			$query .=")";
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_area.php" class="clearfix">
              ...
              <button type="submit" name="add_area" class="btn btn-primary">Agregar</button>
