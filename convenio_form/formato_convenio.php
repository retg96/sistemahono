...
//$pagoDeConvenio = floatval($Subtotal);

$pagoDeConvenio = number_format($Subtotal, 2, '.', '');

/*$pagoDeConvenioLetras = new NumberFormatter("es-ES", NumberFormatter::SPELLOUT);
$enteros = intval(floor($pagoDeConvenio));
$decimales = intval(($n - floor($pagoDeConvenio)) * 100);
echo $formatterES->format($enteros) . "PESOS CON " . $formatterES->format($decimales);*/


//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//SECCION PARA OBTENER VARIABLES DE DATOS PARA EL CONVENIO
...
while($f3=mysqli_fetch_array($result3)) {
    ...
    $diaSf2= date("d", strtotime($f3['FinContrato'])); $mesSf2= date("m", strtotime($f3['FinContrato'])); $anioSf2= date("Y", strtotime($f3['FinContrato']));
...
while($f4=mysqli_fetch_array($result4)) {
    ...
    $valuesP[$cont2]=['NPago'=>$cont2+1,'diaInicioP'=>$diaf1,'mesInicioP'=>$mesLf1,'anioInicioP'=>$aniof1,
...
$asignaturas = implode(", ",$asignatura);
...
$templateWord->setValue('Profesion',$profesionDocente);
...
//$templateWord->setValue('montoapagarletras', $pagoDeConvenioLetras);
