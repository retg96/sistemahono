    ...
    <div class="panel panel-default">
     ...
     <div class="panel-body">
      <table class="table table-bordered table-striped" id="mitabla">
        ...
        <tbody class="boddy">
        <?php 
            $query = "SELECT personaloperativo.IdPersonalOperativo, personaloperativo.ClaveSie, personaloperativo.Nombre, personaloperativo.ApPat,personaloperativo.ApMat, regimen.Regimen,departamento.Departamento FROM personaloperativo INNER JOIN regimen ON personaloperativo.IdRegime = regimen.IdRegime INNER JOIN departamento ON personaloperativo.IdDepartamento = departamento.IdDepartamento WHERE personaloperativo.ClaveSie NOT LIKE '' ORDER By personaloperativo.ClaveSie";
