<?php
  $page_title = 'Agregar Periodo Sin Pago';
...
<?php
 	if(isset($_POST['add_periodo'])){
		...
		if(empty($errors)){
			...
			//  }
			//  $date    = make_date();
			$query  = "INSERT INTO rangonopago (";
			$query .=" FechaInicio,FechaFin,Descripcion";
			$query .=") VALUES (";
			$query .=" '{$p_fi}', '{$p_ff}', '{$p_fcf}'";
			$query .=")";
     ...
     redirect('add_periodo_sin_pago.php',false);
   }
 }
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar Periodo Sin Pago</span>
         </strong>
        </div>
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_periodo_sin_pago.php" class="clearfix">
