...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group">
                  <label for="username" class="control-label">Rol</label>
                  <input type="text" class="form-control" name="username" value="<?php echo remove_junk(ucwords($user['clave'])); ?>">
            </div>
    ...
    <!-- <input type="button" class="btn btn-danger" value="Regresar" onclick="history.go(-1);"><br> -->
  </div>
</div>
