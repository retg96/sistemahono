<?php
  $page_title = 'Agregar Motivo de Ausencia';
...
<?php
 	if(isset($_POST['add_motivo'])){
		...
		if(empty($errors)){
			...
			//  }
			//  $date    = make_date();
			$query  = "INSERT INTO motivoausencia (";
			$query .=" MotivoAusencia";
			$query .=") VALUES (";
			$query .=" '{$p_fi}'";
			$query .=")";
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="add_motivo.php" class="clearfix">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">

                        <div class="form-group">
                            <label for="">Motivo Ausencia</label>
              ...
              <button type="submit" name="add_motivo" class="btn btn-primary">Agregar</button>
