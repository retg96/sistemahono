<?php
  $page_title = 'Editar Nivel de Estudios';
  ...
  redirect('nivel_estudios.php');
 	...
 	if(isset($_POST['upd_nivel'])){
		...
		if(empty($errors)){
            ...
            $query   = "UPDATE nivelestudio SET";
            $query  .=" NivelEstudio ='{$p_fi}'";
            $query  .=" WHERE id ='{$nivel['id']}'";
            
            $result = $db->query($query);
            if( $result ) {
                if( $db->affected_rows() === 1 ) {
                    $session->msg('s',"El nivel de estudio ha sido actualizado correctamente.");
                } else {
                    /* no row was changed */
                ...
                redirect('nivel_estudios.php', false);
                    }
                                else {
                                    /* SQL query error */
                    ...
                    redirect('edit_nivel.php?id='.$nivel['id'], false);
                    }
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <form id="register_form" novalidate method="post" action="edit_nivel.php?id=<?php echo (int)$nivel['id'] ?>" class="clearfix">
                ...
                <div class="row">
                  <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  name='FI' id='fi' value="<?php echo remove_junk($nivel['NivelEstudio']);?>">
                        </div>
                    </div>
                    </div>
                </div>
