        ...
        <div class="panel-heading">
          <strong>
            ...
            <span>Editar Convenio</span>
				...
				<?php 
					$idconvenio = $_GET['id'];
					$query = "SELECT personaloperativo.id,personaloperativo.ClaveSie,personaloperativo.NombreCompleto,personaloperativo.Calle,personaloperativo.RFC,regimen.Regimen,convenioope.FechaInicio,convenioope.FechaFin FROM personaloperativo INNER JOIN regimen ON personaloperativo.IdRegime=regimen.id INNER JOIN convenioope ON personaloperativo.id=convenioope.idpersonalOperativo WHERE convenioope.id=".$idconvenio." ";
                   ...
                   <div class='datos_personal-flex'>
                   		<div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type='date' name='FechaInicio'  value="<?php echo $f['FechaInicio']?>" required>
                            </div>

                            <div class="form-group">
                                <label>Fin de Contrato:</label>
                                <input class="form-control" type='date' name='FechaFin' value="<?php echo $f['FechaFin']?>" required>
                            </div>
