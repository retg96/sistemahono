    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="add_modalidad.php" class="btn btn-info pull-right">AGREGAR MODALIDAD</a>
      </div>
      ...
      <table class="table table-bordered table-striped" id="mitabla">
        ...
        <?php foreach($all_modalidades as $modalidad): ?>
          <tr>
           ...
           <div class="btn-group">
              <a href="edit_modalidad.php?id=<?php echo (int)$modalidad['id'];?>" class="btn btn-warning btn-xs" style="margin: 2px !important;" title="Editar" data-toggle="tooltip">
                <span class="glyphicon glyphicon-edit"></span>
              </a>

              <a href="delete_modalidad.php?id=<?php echo (int)$modalidad['id'];?>" class="btn btn-danger btn-xs btn-del" style="margin: 2px !important;" title="Eliminar" data-toggle="tooltip">
